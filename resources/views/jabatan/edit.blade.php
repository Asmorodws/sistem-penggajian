                    ...
                    <div class="card-body card-block">
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="nama_jabatan"
                                    placeholder="masukkan nama jabatan" value="{{ $data->nama_jabatan }}"
                            ...
                            <div class="col col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="number" id="input1-group1" name="gaji_pokok"
                                        placeholder="masukkan gaji pokok" value="{{ $data->gaji_pokok }}"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col col-md-9">
                                <div class="input-group">
                                    <input type="number" id="input2-group1" name="bonus" min="0" max="100"
                                        value="{{ $data->bonus }}" placeholder="masukkan bonus" class="form-control">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col col-md-9">
                                <div class="input-group">
                                    <input type="number" id="input2-group1" name="pph" min="0" max="100"
                                        value="{{ $data->pph }}" placeholder="masukkan PPH" class="form-control">
                                    <div class="input-group-addon"><i class="fa fa-percent"></i></div>
                                </div>
                            </div>
                        </div>
